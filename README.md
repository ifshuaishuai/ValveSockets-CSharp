...
When building for Linux, macOS, or FreeBSD, you need to define `VALVE_CALLBACK_PACK_SMALL`. For all other platforms (like Windows), define `VALVE_CALLBACK_PACK_LARGE` instead.
